...
export const HUB_GROUPS: HubGroup[] = [
  {
    slug: "driver",
    name: "ドライバー職",
    catSlugs: ["taxi-driver", "bus-driver", "hire-driver", "truck-driver", "shuttle-driver"],
    lead: "タクシー・バス・ハイヤー・トラック・送迎など、人やモノを運ぶドライバー職の求人をまとめました。二種免許・大型免許の取得支援や未経験歓迎の求人も多く、地域や車種から自分に合った働き方を選べます。",
  },
  {
    slug: "mechanic",
    name: "整備士",
