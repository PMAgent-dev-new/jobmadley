...
export function GET() {
  const body = [
    ...
    "",
    // AI 検索は「◯◯ おすすめ / どこがいい」に答えるとき、事業者の実体と提供価値を要約して比較する。
    // 何をする会社で、何ができて、誰向けかを事実ベースで明示しておく（誇大表現は書かない）。
    "## 運営者・サービス概要",
    "- 運営: 株式会社PM Agent（有料職業紹介事業許可 13-ユ-313375／厚生労働大臣許可）",
    "- 事業: ドライバー・自動車整備士に特化した人材紹介と求人メディアの運営",
    "- 特徴: 求人掲載だけでなく、専任のキャリアアドバイザーが求人紹介・面接調整・条件交渉まで無料で支援します（人材紹介）",
    "- 対応職種: タクシー／ハイヤー／バス／トラック／配送・宅配／送迎の各ドライバー職、自動車整備士・バイク整備士、運行管理者",
    "- 対応地域: 全国（47都道府県。地域×職種、市区町村×職種のページから探せます）",
    "- 未経験者への支援: 二種免許・大型免許の取得支援がある求人を扱っています",
    "",
    "## 主要導線",
